...
class AdminRepository:
    ...
    def get_high_risk_restaurants(
        ...
        restaurants = (
            ...
            .filter(
                Restaurant.safety_score < HIGH_RISK_SAFETY_SCORE
            )
            .all()
        )
    ...
    def get_overdue_inspections(
        ...
        rows = (
            ...
            .join(
                ...
                Restaurant.restaurant_id
                ==
                latest_inspection.c.restaurant_id,
            ...
            .order_by(
                ...
                latest_inspection.c.last_inspection.asc()
