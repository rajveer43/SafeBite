...
class AdminService:
    ...
    def get_dashboard(self) -> AdminDashboardResponse:
        ...
        dashboard = self.admin_repository.get_dashboard_statistics()
    ...
    def get_recent_users(
        ...
        users = self.user_repository.get_recent_users()

        return [AdminMapper.recent_user(user) for user in users]

    def get_recent_restaurants(
        self,
    ):

        restaurants = self.admin_repository.get_recent_restaurants()

        return [
            AdminMapper.recent_restaurant(restaurant)
    ...
    def get_high_risk_restaurants(
        ...
        return self.admin_repository.get_high_risk_restaurants()

    def get_pending_complaints(
        self,
    ):

        complaints = self.admin_repository.get_pending_complaints()

        return [
            AdminMapper.pending_complaint(complaint)
    ...
    def get_pending_certificates(
        ...
        certificates = self.admin_repository.get_pending_certificates()

        return [
            AdminMapper.pending_certificate(certificate)
    ...
    def get_expiring_certificates(
        ...
        certificates = self.admin_repository.get_expiring_certificates()
    ...
    def get_overdue_inspections(
        ...
        rows = self.admin_repository.get_overdue_inspections()
    ...
    def get_pending_owners(
        ...
        owners = self.admin_repository.get_pending_owners()

        return [AdminMapper.pending_owner(owner) for owner in owners]
    ...
    def update_verification_status(
        ...
        if user.role != UserRole.OWNER:
            ...
            raise ValueError("Only owners require verification.")
        ...
        is_verified = user.verification_status == VerificationStatus.VERIFIED
        ...
        NotificationService(
            ...
            message=(
                ...
                if is_verified
                else f"Hello {user.name}, your owner account verification has "
        ...
        return AdminMapper.verification_status_updated(user)
