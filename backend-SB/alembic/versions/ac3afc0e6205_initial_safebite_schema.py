...
def upgrade() -> None:
    ...
    sa.Column('role', sa.Enum('customer', 'owner', 'inspector', 'admin', name='userrole'), nullable=False),
    ...
    sa.Column('restaurant_id', sa.UUID(), nullable=False),
    sa.Column('certificate_type', sa.Enum('FSSAI', 'FIRE_SAFETY', 'HEALTH', 'HYGIENE', 'OTHER', name='certificatetype'), nullable=False),
    ...
    sa.Column('status', sa.Enum('PENDING', 'VERIFIED', 'EXPIRED', 'REJECTED', name='certificatestatus'), nullable=False),
    ...
    sa.Column('status', sa.Enum('PENDING', 'UNDER_INVESTIGATION', 'RESOLVED', name='complaintstatus'), nullable=False),
    ...
    sa.Column('inspection_weight', sa.Numeric(precision=5, scale=2), nullable=False),
    sa.Column('complaint_weight', sa.Numeric(precision=5, scale=2), nullable=False),
    sa.Column('certificate_weight', sa.Numeric(precision=5, scale=2), nullable=False),
    sa.Column('feedback_weight', sa.Numeric(precision=5, scale=2), nullable=False),
